    ...
    <div className='w-full mt-6 mx-auto container' style={{height: '45px'}}>
      ...
      <div class="relative text-gray-600 focus-within:text-gray-400">
        <span class="absolute inset-y-0 right-0 flex items-center px-2">
          <button type="submit" onClick={() =>  copy(props.data)} class="p-1 text-white focus:outline-none focus:shadow-outline">
            {
              ...
              : (<svg class="checkmark pb-2" style={{color: 'white', stroke:'white', width: '40px', height: '40px', strokeWidth: '2'}} xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 40 40"><path class="checkmark__check" fill="none" d="M14.1 27.2l7.1 7.2 16.7-16.8"/></svg>)
            }
              </button>
        </span>
