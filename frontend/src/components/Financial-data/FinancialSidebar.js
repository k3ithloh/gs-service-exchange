...
const FinancialSidebar = () => {
  ...
  return (
   ...
   <div className="overflow-y-auto h-full py-6 px-3 bg-gray-50 rounded dark:bg-gray-800">
      <ul className="space-y-2">
         <li>
            <a href="/financial-data/overview" className="flex items-center p-2 text-base font-normal text-gray-900 rounded-lg dark:text-black hover:bg-gray-100 dark:hover:bg-gray-700">
         ...
         <li>
            <a href="/financial-data/documentation" className="flex items-center p-2 text-base font-normal text-gray-900 rounded-lg dark:text-black hover:bg-gray-100 dark:hover:bg-gray-700">
               ...
               <span className="flex-1 ml-3 whitespace-nowrap">API Documentation</span>
            </a>
         </li>
      </ul>
   </div>
